# Django settings for gcmserver project.
import os
import sys
...
ROOT_URLCONF = 'gcmserver.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'gcmserver.wsgi.application'
...
#GCM_DEVICE_MODEL = 'gcmserver.app.models.UserDevice'
